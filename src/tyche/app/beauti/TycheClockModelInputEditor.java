...
/**
 * InputEditor for Tyche clock models (type-linked branch rate models)
 * 
 * @author Jessie Fielding
 */
public class TycheClockModelInputEditor extends BEASTObjectInputEditor {
    
    public TycheClockModelInputEditor() {
        super();
    }

    @Override
    public Class<?> type() {
        return AbstractTycheTypeLinkedClockModel.class;
    }
}
