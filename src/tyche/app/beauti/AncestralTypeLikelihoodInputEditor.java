...
/**
 * InputEditor for Tyche's AncestralTypeLikelihood
 * 
 * @author Jessie Fielding
 */
public class AncestralTypeLikelihoodInputEditor extends BEASTObjectInputEditor {
    
    public AncestralTypeLikelihoodInputEditor() {
        super();
    }
