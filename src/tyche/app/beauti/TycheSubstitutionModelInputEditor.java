...
/**
 * InputEditor for Tyche's substitution models
 * 
 * @author Jessie Fielding
 */
public class TycheSubstitutionModelInputEditor extends BEASTObjectInputEditor {
    
    public TycheSubstitutionModelInputEditor() {
        super();
    }
